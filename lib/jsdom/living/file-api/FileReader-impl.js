...
class FileReaderImpl extends EventTargetImpl {
  constructor(args, privateData) {
    ...
    this._ownerDocument = this._window.document;
  ...
  _fireProgressEvent(name, props) {
    const dict = Object.assign({ bubbles: false, cancelable: false }, props);
    const event = this._window._core.ProgressEvent.createImpl([name, dict], {});
