...
const ProgressEvent = require("./generated/ProgressEvent").interface;
...
module.exports = function createXMLHttpRequest(window) {
  class XMLHttpRequest extends XMLHttpRequestEventTarget.interface {
    constructor() { // eslint-disable-line constructor-super
      ...
      const uploadImpl = XMLHttpRequestUpload.createImpl();
      uploadImpl._ownerDocument = window._document;
      theThis.upload = idlUtils.wrapperForImpl(uploadImpl);
