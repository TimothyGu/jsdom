...
class DocumentImpl extends NodeImpl {
  constructor(args, privateData) {
    ...
    this._getDefaultView = privateData.options.getDefaultView || null;
  ...
  get defaultView() {
    if (!this._getDefaultView) return null;
  ...
  get hidden() {
    if (this.defaultView && this.defaultView._pretendToBeVisual) {
      return false;
    }
