...
class DocumentImpl extends NodeImpl {
  constructor(args, privateData) {
    ...
    this._elementBuilders = Object.create(null);
    registerElements(this);

    this._initGlobalEvents();

    this._eventInterfaceTable = {
      compositionevent: this._window._core.CompositionEvent,
      customevent: this._window._core.CustomEvent,
      errorevent: this._window._core.ErrorEvent,
      event: this._window._core.Event,
      events: this._window._core.Event,
      focusevent: this._window._core.FocusEvent,
      hashchangeevent: this._window._core.HashChangeEvent,
      htmlevents: this._window._core.Event,
      keyboardevent: this._window._core.KeyboardEvent,
      messageevent: this._window._core.MessageEvent,
      mouseevent: this._window._core.MouseEvent,
      mouseevents: this._window._core.MouseEvent,
      popstateevent: this._window._core.PopStateEvent,
      progressevent: this._window._core.ProgressEvent,
      svgevents: this._window._core.Event,
      textevent: this._window._core.CompositionEvent,
      touchevent: this._window._core.TouchEvent,
      uievent: this._window._core.UIEvent,
      uievents: this._window._core.UIEvent
    };
    ...
    this._htmlToDom = new HTMLToDOM(this._window._core, privateData.options.parsingMode);

    this._implementation = this._window._core.DOMImplementation.createImpl([], {
      ownerDocument: this
    });
    ...
    this._location = this._window._core.Location.createImpl([], { relevantDocument: this });
    this._history = this._window._core.History.createImpl([], {
      document: this,
  ...
  _createElementWithCorrectElementInterface(name, namespace) {
    ...
    if (this._elementBuilders[namespace] && this._elementBuilders[namespace][name.toLowerCase()]) {
      return this._elementBuilders[namespace][name.toLowerCase()](name, namespace);
    } else if (namespace === "http://www.w3.org/1999/xhtml") {
      return this._window._core.HTMLUnknownElement.createImpl([], {
        ownerDocument: this,
        localName: name
      });
    } else if (namespace === "http://www.w3.org/2000/svg") {
      return this._window._core.SVGElement.createImpl([], {
        ownerDocument: this,
        localName: name
      });
    }

    return this._window._core.Element.createImpl([], {
      ownerDocument: this,
      localName: name
    });
  }
  ...
  get links() {
    return this._window._core.HTMLCollection.createImpl([], {
      element: this,
  ...
  getElementsByName(elementName) {
    return this._window._core.NodeList.createImpl([], {
      element: this,
      query: () => domSymbolTree.treeToArray(this, {
  ...
  createEvent(type) {
    ...
    const eventWrapper = this._eventInterfaceTable[typeLower] || null;
  ...
  createProcessingInstruction(target, data) {
    ...
    return this._window._core.ProcessingInstruction.createImpl([], {
      ownerDocument: this,
      target,
      data
    });
  ...
  createCDATASection(data) {
    ...
    return this._window._core.CDATASection.createImpl([], {
      ownerDocument: this,
      data
    });
  }
  ...
  createTextNode(data) {
    return this._window._core.Text.createImpl([], {
      ownerDocument: this,
      data
    });
  }
  ...
  createComment(data) {
    return this._window._core.Comment.createImpl([], {
      ownerDocument: this,
      data
    });
  }
  ...
  createDocumentFragment() {
    return this._window._core.DocumentFragment.createImpl([], { ownerDocument: this });
  }

  createAttribute(localName) {
    const { Attr } = this._window._core;
    ...
    return Attr.createImpl([], { localName });
  }
  ...
  createTreeWalker(root, whatToShow, filter) {
    return this._window._core.TreeWalker.createImpl([], { root, whatToShow, filter });
  }

  createNodeIterator(root, whatToShow, filter) {
    const nodeIterator = this._window._core.NodeIterator.createImpl([], { root, whatToShow, filter });
  ...
  importNode(node, deep) {
    ...
    return clone(this._window._core, node, this, deep);
  }
  ...
  get styleSheets() {
    if (!this._styleSheets) {
      this._styleSheets = new this._window._core.StyleSheetList();
    }
