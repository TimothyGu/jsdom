...
exports.implementation = class HTMLOptionsCollectionImpl extends HTMLCollectionImpl {
  ...
  add(element, before) {
    ...
    if (this._window._core.Element.isImpl(before) &&
        !(this._element.compareDocumentPosition(before) & DOCUMENT_POSITION_CONTAINED_BY)) {
    ...
    let reference = null;
    if (this._window._core.Node.isImpl(before)) {
      reference = before;
