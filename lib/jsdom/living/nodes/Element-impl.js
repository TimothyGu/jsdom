...
class ElementImpl extends NodeImpl {
  constructor(args, privateData) {
    ...
    this._attributes = this._window._core.NamedNodeMap.createImpl([], {
      element: this
    });
  }
  ...
  set outerHTML(html) {
    ...
    if (parent.nodeType === NODE_TYPE.DOCUMENT_NODE) {
      ...
      contextElement = clone(this._window._core, parent, undefined, false);
    } else {
  ...
  get classList() {
    if (this._classList === undefined) {
      this._classList = this._window._core.DOMTokenList.createImpl([], {
        element: this,
  ...
  setAttribute(name, value) {
    ...
    if (attribute === null) {
      const newAttr = this._window._core.Attr.createImpl([], { localName: name, value });
