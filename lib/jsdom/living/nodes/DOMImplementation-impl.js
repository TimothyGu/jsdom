...
class DOMImplementationImpl extends WebIDLInterfaceImpl {
  ...
  createDocumentType(qualifiedName, publicId, systemId) {
    ...
    return this._window._core.DocumentType.createImpl([], {
  ...
  createDocument(namespace, qualifiedName, doctype) {
    ...
    const document = this._window._core.Document.createImpl([], {
  ...
  createHTMLDocument(title) {
    ...
    const doctype = this._window._core.DocumentType.createImpl([], {
      ownerDocument: this,
      name: "html",
      publicId: "",
      systemId: ""
