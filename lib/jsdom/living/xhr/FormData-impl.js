...
exports.implementation = class FormDataImpl extends WebIDLInterfaceImpl {
  ...
  _createAnEntry(name, value, filename) {
    const { Blob, File } = this._window._core;
    const entry = { name };
  ...
  append(name, value, filename) {
    ...
    const entry = this._createAnEntry(name, value, filename);
