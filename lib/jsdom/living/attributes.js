...
exports.setAttributeValue = function (element, localName, value, prefix, namespace) {
  ...
  if (attribute === null) {
    const { Attr } = element._window._core;
    const newAttribute = Attr.createImpl([], { namespace, namespacePrefix: prefix, localName, value });
...
exports.copyAttributeList = function (sourceElement, destElement) {
  ...
  for (const sourceAttr of sourceElement._attributeList) {
    const destAttr = destElement._window._core.Attr.createImpl([], {
