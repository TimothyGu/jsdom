...
function getWindow() {
  ...
  return Window = require("../generated/Window");
}
...
exports.appendHandler = function appendHandler(el, eventName) {
  el.addEventListener(eventName, event => {
    ...
    const specialError = ErrorEvent.isImpl(event) && event.type === "error" &&
      getWindow().isImpl(event.currentTarget);
  ...
  Object.defineProperty(obj, "on" + event, {
    ...
    get() { // https://html.spec.whatwg.org/#getting-the-current-value-of-the-event-handler
      ...
      if (value.body !== undefined) {
        ...
        const window = getWindow().isImpl(this) && this._document ? this : document._defaultView;
        ...
        let fn;
        const createFunction = vm.isContext(document._defaultView._wrapper) ? document._defaultView._globalProxy.Function : Function;
